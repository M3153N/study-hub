...
export const conceptIconCatalog: Record<ConceptIconId, { label: string; group: 'capm' | 'iso27001' | 'itil4' }> = {
  stakeholder:{label:'Interesado',group:'capm'}, 'project-manager':{label:'Director de proyecto',group:'capm'}, pmo:{label:'PMO',group:'capm'}, 'product-owner':{label:'Product Owner',group:'capm'}, sponsor:{label:'Patrocinador',group:'capm'}, team:{label:'Equipo',group:'capm'}, risk:{label:'Riesgo',group:'capm'}, planning:{label:'Planificación',group:'capm'}, schedule:{label:'Cronograma',group:'capm'}, scope:{label:'Alcance',group:'capm'}, cost:{label:'Costos',group:'capm'}, quality:{label:'Calidad',group:'capm'}, predictive:{label:'Predictivo',group:'capm'}, agile:{label:'Ágil',group:'capm'}, hybrid:{label:'Híbrido',group:'capm'},
