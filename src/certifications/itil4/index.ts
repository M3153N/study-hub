...
export const itil4: CertificationPack = {
  ...
  exam: { id:'itil-demo-exam', title:'Simulacro ITIL 4 demostrativo', durationMinutes:10, questionCount:6, passingPercent:67, domainWeights:{'Conceptos':2/6,'Principios guía':1/6,'Sistema de valor':1/6,'Prácticas':1/6,'Mejora':1/6} },
  campaign: { id:'itil-campaign-v1', certificationId:'itil4', chapters:[
    {id:'itil-value',title:'Cocrear valor',description:'Servicios, principios y flujos.',nodes:[{id:'itil-read-value',title:'Leer: valor con servicios',kind:'resource',resource:{kind:'reading',id:'itil-value'},rewardXp:5},{id:'itil-practice-value',title:'Valor en práctica',kind:'practice',questionIds:['ITIL-DEMO-001','ITIL-DEMO-002','ITIL-DEMO-004'],requiredCorrect:2,rewardXp:15}]},
    {id:'itil-operate',title:'Operar y mejorar',description:'Incidentes, cambios y mejora continua.',nodes:[{id:'itil-map-svs',title:'Mapa del SVS',kind:'resource',resource:{kind:'maps',id:'itil-svs'},rewardXp:5},{id:'itil-review',title:'Repaso inteligente',kind:'review',rewardXp:10},{id:'itil-final',title:'Desafío del servicio',kind:'challenge',questionIds:['ITIL-DEMO-003','ITIL-DEMO-004','ITIL-DEMO-005','ITIL-DEMO-006'],requiredCorrect:3,rewardXp:25}]}
  ]},
  questions: [
