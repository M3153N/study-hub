...
export const iso27001: CertificationPack = {
  ...
  exam: { id:'iso-demo-exam', title:'Simulacro ISO 27001 LI demostrativo', durationMinutes:10, questionCount:6, passingPercent:67, domainWeights:{'SGSI':1/6,'Riesgos':1/6,'Liderazgo':1/6,'Controles':1/6,'Evaluación':1/6,'Mejora':1/6} },
  campaign: { id:'iso-campaign-v1', certificationId:'iso27001', chapters:[
    {id:'iso-build',title:'Construir el SGSI',description:'Contexto, riesgos y aplicabilidad.',nodes:[{id:'iso-read-scope',title:'Un alcance defendible',kind:'resource',resource:{kind:'reading',id:'iso-scope'},rewardXp:5},{id:'iso-practice-core',title:'Diseñar el sistema',kind:'practice',questionIds:['ISO-DEMO-001','ISO-DEMO-002','ISO-DEMO-003','ISO-DEMO-004'],requiredCorrect:3,rewardXp:15}]},
    {id:'iso-improve',title:'Evaluar y mejorar',description:'Auditoría, desempeño y mejora.',nodes:[{id:'iso-map-pdca',title:'Mapa de mejora',kind:'resource',resource:{kind:'maps',id:'iso-pdca'},rewardXp:5},{id:'iso-review',title:'Repaso inteligente',kind:'review',rewardXp:10},{id:'iso-final',title:'Desafío de implementación',kind:'challenge',questionIds:['ISO-DEMO-001','ISO-DEMO-004','ISO-DEMO-005','ISO-DEMO-006'],requiredCorrect:3,rewardXp:25}]}
  ]},
  questions: [
